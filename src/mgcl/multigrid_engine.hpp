...
namespace mgcl
{
    ...
    public:
        ...
        static void updateGhostsSeqGlobalBoundariesMpi(Cuboid& c, MPILevelData* mpiData);
        static int updateGhosts(Problem& problem, Level& lv, CuboidGpu& dBuffer, MPILevelData* mpiData, bool forceLocal);
        static void updateGhostsOclMpi(Problem& p, Level& lv, CuboidGpu& d_buf, MPILevelData& mpiData,
        ...
        static std::unique_ptr<Blockstencil> galerkinOptimized(Blockstencil& a_h, FixedBlockstencil& r, FixedBlockstencil& p,
                                                               int gh_a2h,
                                                               int resm, int resn, int reso);
        static std::unique_ptr<BlockstencilGpu> galerkinOptimized(BlockstencilGpu& a_h, FixedBlockstencilGpu& r, FixedBlockstencilGpu& p,
                                                                  int gh_a2h,
                                                                  int resm, int resn, int reso,
                                                                  cl_program program, cl_command_queue queue, cl_context context,
                                                                  conf::KernelConfig* kernelConfig, ProfilingData* pd);
