...
namespace mgcl::conf
{
    ...
    KernelConfig createDefaultKernelConfig()
    {
        ...
        ret["jacobi_iter_27point_varying_stencil_1d_boundary"] = mgcl::conf::KernelWorkgroupSizes{{1, {128, 1, 1}}};
        ret["jacobi_iter_27point_fixed_stencil_1d_boundary"] = mgcl::conf::KernelWorkgroupSizes{{1, {128, 1, 1}}};
        ret["jacobi_iter_7point_boundary"] = mgcl::conf::KernelWorkgroupSizes{{1, {1, 64, 1}}};
        ret["jacobi_iter_19point_boundary"] = mgcl::conf::KernelWorkgroupSizes{{1, {1, 64, 1}}};
        ...
        ret["jacobi_iter_27point_blockstencil_block_first_v_block_first_blockjacobi"] = KernelWorkgroupSizes{{1, {128, 1, 1}}};
        ret["jacobi_iter_27point_blockstencil_block_first_v_block_first_scalarjacobi"] = KernelWorkgroupSizes{{1, {128, 1, 1}}};
