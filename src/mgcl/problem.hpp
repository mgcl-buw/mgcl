...
namespace mgcl
{
    ...
    private:
        ...
        /* If true, the final ghost update of R and V will be done in two separate queues, s.t. it can be done simultaneously.
         * This perhaps might be beneficial in multi-gpu scenario. */
        bool useTwoQueuesForJacobi = false;
    ...
    public:
        ...
        bool getUseTwoQueuesForJacobi() const { return useTwoQueuesForJacobi; }
        void setUseTwoQueuesForJacobi(bool useTwoQueuesForJacobi_) { useTwoQueuesForJacobi = useTwoQueuesForJacobi_; }
