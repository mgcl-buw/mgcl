...
// Tests if vcycle is correct for multiple processes with mpiLevelThreshold > 0, i.e. some fine levels are
// calculated distributed and only the coarse levels are calculated on rank 0.
// Run with e.g. mpiexec -n 2 tests_mpi MPI_vcycle_threshold_gt_0_Varying27p
TEST_CASE("MPI_vcycle_threshold_gt_0_Varying27p")
{
    using std::min;
...
// Tests if vcycle is correct for multiple processes with mpiLevelThreshold > 0, i.e. some fine levels are
// calculated distributed and only the coarse levels are calculated on rank 0.
// Run with e.g. mpiexec -n 2 tests_mpi MPI_vcycle_GPU_threshold_gt_0_Varying27p
TEST_CASE("MPI_vcycle_GPU_threshold_gt_0_Varying27p")
{
    using std::min;
