...
TEST_CASE("CuboidBSGpu ctor no host_data", "[ocl]")
{
    ...
    SECTION("success")
    {
        ...
        mgcl::CuboidBSGpu c(tu.getContext(), CL_MEM_READ_WRITE, 1, 2, 3, 2, 3, 4);
    ...
    {
        mgcl_test::TestUtility tu(deviceType);
        REQUIRE_THROWS(mgcl::CuboidBSGpu(tu.getContext(), CL_MEM_READ_WRITE, 0, 2, 3, 2, 3, 4));
        REQUIRE_THROWS(mgcl::CuboidBSGpu(tu.getContext(), CL_MEM_READ_WRITE, 1, 0, 3, 2, 3, 4));
        REQUIRE_THROWS(mgcl::CuboidBSGpu(tu.getContext(), CL_MEM_READ_WRITE, 1, 2, 0, 2, 3, 4));
        REQUIRE_THROWS(mgcl::CuboidBSGpu(tu.getContext(), CL_MEM_READ_WRITE, 1, 2, 3, -1, 3, 4));
        REQUIRE_THROWS(mgcl::CuboidBSGpu(tu.getContext(), CL_MEM_READ_WRITE, 1, 2, 3, 2, -1, 4));
        REQUIRE_THROWS(mgcl::CuboidBSGpu(tu.getContext(), CL_MEM_READ_WRITE, 1, 2, 3, 2, 3, -1));
    }

    SECTION("invalid flags")
    {
        mgcl::CuboidBS ch(1, 2, 3, 2, 3, 4);
        mgcl_test::TestUtility tu(deviceType);

        // flags must contain one of CL_MEM_READ_WRITE, CL_MEM_WRITE_ONLY or CL_MEM_READ_ONLY.
        REQUIRE_THROWS(mgcl::CuboidBSGpu(tu.getContext(), CL_MEM_COPY_HOST_PTR, 1, 2, 3, 2, 3, 4));
        REQUIRE_THROWS(mgcl::CuboidBSGpu(tu.getContext(), CL_MEM_USE_HOST_PTR, 1, 2, 3, 2, 3, 4));
        REQUIRE_THROWS(mgcl::CuboidBSGpu(tu.getContext(), CL_MEM_ALLOC_HOST_PTR, 1, 2, 3, 2, 3, 4));

        // flags must not not contain CL_MEM_COPY_HOST_PTR, CL_MEM_USE_HOST_PTR or CL_MEM_ALLOC_HOST_PTR
        REQUIRE_THROWS(mgcl::CuboidBSGpu(tu.getContext(), CL_MEM_COPY_HOST_PTR | CL_MEM_READ_WRITE, 1, 2, 3, 2, 3, 4));
        REQUIRE_THROWS(mgcl::CuboidBSGpu(tu.getContext(), CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, 1, 2, 3, 2, 3, 4));
        REQUIRE_THROWS(mgcl::CuboidBSGpu(tu.getContext(), CL_MEM_ALLOC_HOST_PTR | CL_MEM_READ_WRITE, 1, 2, 3, 2, 3, 4));

        // flags must not contain multiple of CL_MEM_READ_WRITE, CL_MEM_WRITE_ONLY or CL_MEM_WRITE_ONLY
        REQUIRE_THROWS(mgcl::CuboidBSGpu(tu.getContext(), CL_MEM_READ_WRITE | CL_MEM_WRITE_ONLY, 1, 2, 3, 2, 3, 4));
        REQUIRE_THROWS(mgcl::CuboidBSGpu(tu.getContext(), CL_MEM_READ_WRITE | CL_MEM_READ_ONLY, 1, 2, 3, 2, 3, 4));
        REQUIRE_THROWS(mgcl::CuboidBSGpu(tu.getContext(), CL_MEM_WRITE_ONLY | CL_MEM_READ_ONLY, 1, 2, 3, 2, 3, 4));
    }
}
...
TEST_CASE("CuboidBSGpu ctor retaining buffer", "[ocl]")
{
    ...
    SECTION("success")
    {
        ...
        mgcl::CuboidBSGpu* c = new mgcl::CuboidBSGpu(tu.getContext(), 0, 1, 2, 3, 2, 3, 4, buf);
...
TEST_CASE("CuboidBSGpu::read into existing", "[ocl]")
{
    ...
    mgcl::CuboidBS ch_act(1, 2, 3, 2, 3, 4);
...
TEST_CASE("CuboidBSGpu::copyTo", "[ocl]")
{
    ...
    SECTION("success")
    {
        ...
        mgcl::CuboidBSGpu c2(tu.getContext(), CL_MEM_READ_WRITE, 1, 2, 3, 2, 3, 4);
    ...
    SECTION("throwing")
    {
        ...
        mgcl::CuboidBSGpu c2(tu.getContext(), CL_MEM_READ_WRITE, 3, 2, 3, 2, 3, 4);
...
TEST_CASE("CuboidBSGpu::swap", "[ocl]")
{
    ...
    SECTION("success")
    {
        mgcl::CuboidBS ch1(1, 1, 1, 0, 0, 0);
        mgcl::CuboidBS ch2(1, 1, 1, 0, 0, 0);
        ch1[0][0][0] = 1.0;
        ch2[0][0][0] = 2.0;
    ...
    SECTION("throwing")
    {
        mgcl::CuboidBSGpu c1(tu.getContext(), CL_MEM_READ_WRITE, 3, 1, 1, 0, 0, 0);
        mgcl::CuboidBSGpu c2(tu.getContext(), CL_MEM_READ_WRITE, 1, 1, 1, 0, 0, 0);
...
TEST_CASE("CuboidBSGpu::copyShallow", "[ocl]")
{
    ...
    SECTION("success")
    {
        ...
        mgcl::CuboidBSGpu c_ro(tu.getContext(), CL_MEM_READ_ONLY, 1, 2, 3, 1, 2, 3);
        mgcl::CuboidBSGpu c_wo(tu.getContext(), CL_MEM_WRITE_ONLY, 1, 2, 3, 1, 2, 3);
...
TEST_CASE("CuboidBSGpu::extract_border_planes", "[ocl]")
{
    ...
    SECTION("indices")
    {
        ...
        mgcl::CuboidBS h_res(1, 1, ressize);
