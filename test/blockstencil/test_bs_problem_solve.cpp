...
/**
 * @brief Tests if solving works correctly for u = x^4 * (x-1)^4, where a scalar grid is vectorized (same test case
 * as for Jacobi).
 *
 */
TEST_CASE("solve_bs_periodic_combined_scalars")
{
    int Nscalar = 16;
    int bsfactor = 2;
    ...
    SECTION("Sequential")
    {
        ...
        SECTION("block")
        {
            ...
            mgcl_test::copyCuboidToCuboidBS(*vsc, *vbs, bsfactor, bsfactor, bsfactor);
            mgcl_test::copyCuboidToCuboidBS(*fsc, *fbs, bsfactor, bsfactor, bsfactor);
            ...
            SECTION("Blockstencil_Jacobiscalar")
            {
                ...
                mgcl_test::copyCuboidBSToCuboid(*vbs, *vsc, bsfactor, bsfactor, bsfactor);
...
TEST_CASE("solve_bs_periodic_independent_quantities")
{
    ...
    SECTION("Sequential")
    {
        SECTION("Galerkin_27p vs blockstencil with scalar Jacobi")
        {
