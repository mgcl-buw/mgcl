...
TEST_CASE("VaryingStencilGpu::multiply(var)")
{
    ...
    int o = 4;
    int gh = 2;
    bool periodic = GENERATE(false, true);
    ...
    SECTION("widths 3 * 3")
    {
        ...
        auto c = a->multiply(*b, 2, nullptr, nullptr, nullptr, t.getProgram(), t.getCommands(), t.getContext(), nullptr, true, periodic, nullptr, nullptr);
        t.finish();
