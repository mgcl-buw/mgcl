...
namespace mgcl_bench_residual_varying
{
    ...
    TEST_CASE("residualVaryingKernelVersions")
    {
        ...
        for (auto gr : gridsTBT)
        {
            ...
            std::vector<std::vector<size_t>> wg_sizes_shmem_coeffs_first_1d = {{128, 1, 1}, {32, 1, 1}, {64, 1, 1}, {256, 1, 1}};
            ...
            std::vector<std::vector<size_t>> wg_sizes_shmem_3d = {{32, 1, 1}, {64, 1, 1}, {128, 1, 1}};
            {
            ...
            {
                std::vector<std::vector<size_t>> wg_sizes = {{16, 1, 1}, {32, 1, 1}, {64, 1, 1}, {128, 1, 1}, {256, 1, 1}};
