...
__kernel void update_ghosts_periodic_3d_modulo(
    __global double* restrict c,
    int m, int n, int o,
    int ghm, int ghn, int gho)
{
...
__kernel void update_ghosts_periodic_3d_typeconv_double(
    __global double* restrict c,
    int m, int n, int o,
    int ghm, int ghn, int gho)
{
...
__kernel void update_ghosts_periodic_3d_typeconv_float(
    __global double* restrict c,
    int m, int n, int o,
    int ghm, int ghn, int gho)
{
