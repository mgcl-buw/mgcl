    ...
    int gha, int ghb, int ghc)
{
    ...
    int cell_c = (i + ghc) * n * o * wcPow3 + (j + ghc) * o * wcPow3 + (k + ghc) * wcPow3;

    int waPow2 = wa * wa;
    int waPow3 = waPow2 * wa;
    int cell_a = (i + gha) * n * o * waPow3 + (j + gha) * o * waPow3 + (k + gha) * waPow3;

    int wbPow2 = wb * wb;
    int wbPow3 = wbPow2 * wb;
    int cell_b = (i + ghb) * n * o * wbPow3 + (j + ghb) * o * wbPow3 + (k + ghb) * wbPow3;
    ...
    if (i < m && j < n && k < o)
    {
        ...
        for (int a_k = 0; a_k < wa; a_k++)
            ...
            {
                int gpi = i + a_i - wb + ghb;
                int gpj = j + a_j - wb + ghb;
                int gpk = k + a_k - wb + ghb;
                ...
                if (ci >= 0 && ci < wc &&
                    ...
                    ck >= 0 && ck < wc)
                {
                    c[cell_c + (a_i + b_i) * wcPow2 + (a_j + b_j) * wc + (a_k + b_k)] +=
